...
public class ViewFX extends Application {
	...
	{
		// Send message to controller to delete billionaire as specified by the selected item in list view
		controller.deleteBillionaire(billionairesLV.getSelectionModel().getSelectedItem());
		deleteButton.setDisable(true);
		// Set selected index of list view back to -1 (no billionaire selected)
